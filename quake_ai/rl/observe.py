...
Usage:
    python -m quake_ai.rl.observe --checkpoint runs/bc_v7_prod_ah2/checkpoints/bc_best_model.pth
    python -m quake_ai.rl.observe --checkpoint path/to/model.pth --scenario-id ffa-dm4-5bot
    python -m quake_ai.rl.observe --checkpoint path/to/model.pth --scenario-id arena-1v1-box --steps 3600
...
_TEMPLATES = Path(__file__).resolve().parent / "run_templates"
_DEFAULT_WORKER = "assets/bin/quake_worker"
