"""Shared PPO execution core and plain PPO runner."""
...
from quake_ai.rl.run_config import build_run_ppo_eval_config
...
def run_training_job(
    ...
    ppo_ckpt: str | None = str(ppo_ckpt_path) if ppo_ckpt_path else None
